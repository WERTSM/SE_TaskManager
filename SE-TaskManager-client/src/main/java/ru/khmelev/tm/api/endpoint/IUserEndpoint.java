...
public interface IUserEndpoint {
    ...
    @WebMethod
    @Action(input = "http://endpoint.api.tm.khmelev.ru/IUserEndpoint/findUserRequest", output = "http://endpoint.api.tm.khmelev.ru/IUserEndpoint/findUserResponse", fault = {@FaultAction(className = SerialException_Exception.class, value = "http://endpoint.api.tm.khmelev.ru/IUserEndpoint/findUser/Fault/SerialException")})
