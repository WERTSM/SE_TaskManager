 ...
 * 2019-04-23T19:19:28.591+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "ProjectEndpointService",
                  wsdlLocation = "http://localhost:2019/ProjectEndpoint?wsdl",
...
public class ProjectEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:2019/ProjectEndpoint?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ProjectEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:2019/ProjectEndpoint?wsdl");
        }
        WSDL_LOCATION = url;
    }
