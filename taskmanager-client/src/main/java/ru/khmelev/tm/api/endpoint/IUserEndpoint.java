...
public interface IUserEndpoint {
    ...
    @WebMethod
    @Action(input = "http://endpoint.api.tm.khmelev.ru/IUserEndpoint/serverInfoRequest", output = "http://endpoint.api.tm.khmelev.ru/IUserEndpoint/serverInfoResponse")
    @RequestWrapper(localName = "serverInfo", targetNamespace = "http://endpoint.api.tm.khmelev.ru/", className = "ru.khmelev.tm.api.endpoint.ServerInfo")
    @ResponseWrapper(localName = "serverInfoResponse", targetNamespace = "http://endpoint.api.tm.khmelev.ru/", className = "ru.khmelev.tm.api.endpoint.ServerInfoResponse")
    @WebResult(name = "return", targetNamespace = "")
