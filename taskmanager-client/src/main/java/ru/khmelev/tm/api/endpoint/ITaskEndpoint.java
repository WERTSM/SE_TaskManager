...
public interface ITaskEndpoint {
    ...
    @WebMethod
    @Action(input = "http://endpoint.api.tm.khmelev.ru/ITaskEndpoint/editTaskRequest", output = "http://endpoint.api.tm.khmelev.ru/ITaskEndpoint/editTaskResponse")
    @RequestWrapper(localName = "editTask", targetNamespace = "http://endpoint.api.tm.khmelev.ru/", className = "ru.khmelev.tm.api.endpoint.EditTask")
    @ResponseWrapper(localName = "editTaskResponse", targetNamespace = "http://endpoint.api.tm.khmelev.ru/", className = "ru.khmelev.tm.api.endpoint.EditTaskResponse")
